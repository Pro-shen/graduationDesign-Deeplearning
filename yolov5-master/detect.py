...
def parse_opt(path):
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/graduationDesign.yaml", help="(optional) dataset.yaml path")
    ...
    parser.add_argument("--project", default=ROOT / "setimage", help="save results to project/name")
